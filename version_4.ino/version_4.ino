...
//expecting 128 x 160
 tft.setRotation(1); 
  ...
  tft.setTextSize(1);
  tft.print("Pocket payment device by"); // 
  ...
  tft.setTextColor(ST77XX_WHITE);
  tft.setTextSize(3);
  tft.print("ONDIGO"); // display "Ondigo" on device screen while booting
...
// checkNetwork();
  ...
  tft.setTextColor(ST77XX_WHITE);
  tft.setTextSize(2);
  tft.print("Enter amount and tap to pay "); // display "scan now" on device screen
 // tft.drawRect(0,100, 0, 100, ST77XX_YELLOW);

  Serial.println("Enter amount and tap to pay "); 
...
tft.setCursor(20, 50); 
  tft.setTextColor(ST77XX_WHITE);
  tft.setTextSize(2);
  tft.print("TAP CARD TO PAY"); // display "scan now" on device screen
 // tft.drawRect(0,100, 0, 100, ST77XX_YELLOW);
